...
/***/ "./src/app/common/search.ts":
/*!**********************************!*\
  !*** ./src/app/common/search.ts ***!
  \**********************************/
/*! exports provided: filterStudentsList, sortStudentsName, sortStudentsbyId */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filterStudentsList", function() { return filterStudentsList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortStudentsName", function() { return sortStudentsName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortStudentsbyId", function() { return sortStudentsbyId; });
/**
 *
 * @param {string, IStudent[]} opts
 */
function filterStudentsList(opts) {
    var fullName;
    var newQuery = opts.students.filter(function (student) {
        fullName = (student.firstName + " " + student.lastName).toLowerCase();
        if (student.id === opts.query ||
...
function sortStudentsName(students) {
...
function sortStudentsbyId(students) {
    return students.sort(function (a, b) {
        if (a.id.slice(2, a.id.length) < b.id.slice(2, b.id.length)) {
            return -1;
        }
        if (a.id.slice(2, a.id.length) > b.id.slice(2, b.id.length)) {
            return 1;
